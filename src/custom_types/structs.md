...
Существует три вида структур, которые можно создать с помощью ключевого слова `struct`:

- Кортежная структура, которая, в общем, является именованным упорядоченным рядом.
- Классическая [C структура](https://en.wikipedia.org/wiki/Struct_(C_programming_language)).
- Единичная структура, которая не имеет полей, но может быть полезна для обобщённых видов.
...
[`свойства`](../attribute.md) и [деструктуризация](../flow_control/match/destructuring.md)
