...
Обычная библиотека предоставляет отличные простейшие для работы потоками из коробки. Они в сочетании с подходом владения и правилами псевдонимов в Ржавчине, самостоятельно предотвращают гонки данных.
