...
Перевод `Ржачина на примерах` находится в этапе наполнения. За ходом перевода можно наблюдать [тут](https://github.com/ruRust/rust-by-example-ru/issues/1).
...
Это исходная рукопись сайта [Ржачина на примерах][website], переведённый на русский язык! Перевод можно найти по адресу https://rurust.github.io/rust-by-example-ru
