...
В Ржачина есть два вида строк: `String` и `&str`.
...
строку любые символы, даже невыводимые и те, которые вы не 
знаете как набрать. Если вы хотите добавить обратную косую черту, 
экранируйте его с помощью ещё одной: `\`.

Строковые или символьные разделители записей (кавычки, встречающиеся внутри другого записи, должны быть экранированы: `"\""`, `'.'`.
...
экранирования символов можно найти в [главе 'Tokens'](https://doc.rust-lang.org/reference/tokens.html) Ржачина Reference.
